...
if ($conn) {
    // Modifica la consulta para filtrar por la categoría "Camiseta"
    $query = "SELECT * FROM productos_ropa WHERE categoria = 'Camiseta' ORDER BY nombre";
...
?>
    ...
    <h2 class="text-3xl font-bold text-center m-8">Nuestras camisetas</h2>
